...
const initialData: BusinessDetailsForm = {
    name: "Biran Varon",
    phone: "0507780228",
    address: "",
    description: "",
...
export default function BusinessDetailsPage() {
    const [form, setForm] = React.useState<BusinessDetailsForm>(initialData);
    const [errors, setErrors] = React.useState<Partial<Record<keyof BusinessDetailsForm, string>>>({});
    const [isSaving, setIsSaving] = React.useState(false);

    const bookingLink = "https://www.progrr.io/b/your-business";
    ...
    const onSave = async () => {
        ...
        try {
            ...
            console.log("[Business details] save", form);
